...
public class ExToast {
    ...
    public void show() {
        ...
        if (mDuration / 1000 > LENGTH_ALWAYS) {
...
//            params.flags = WindowManager.LayoutParams.FLAG_LAYOUT_IN_SCREEN | WindowManager.LayoutParams.FLAG_LAYOUT_IN_SCREEN;
//
//            // }
//
