...
public class DividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private int footview_num = 0;
    private int no_need_divider = 0;
    public boolean need_top_margin = false;
    public boolean use_margin = false;

    public DividerItemDecoration setNeed_top_margin(boolean need_top_margin) {
        this.need_top_margin = need_top_margin;
        return this;
    }

    public DividerItemDecoration setFootview_num(int footview_num) {
        this.footview_num = footview_num;
        no_need_divider = footview_num + 1;
        return this;
    }

    public DividerItemDecoration setHaveFootView() {
        this.footview_num = 1;
        no_need_divider = 2;
        return this;
    }
    ...
    public DividerItemDecoration setUse_margin(boolean use_margin) {
...
//    }
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        ...
        switch (mOrientation) {
            case BOTH_SET:
                ...
                outRect.set(0, 0, (itemPosition%spanCount==spanCount-1)?0:mDividerHeight, mDividerHeight);
                break;
            case VERTICAL_LIST:
                childCount -= 1;
            ...
            case HORIZONTAL_LIST:
                ...
                int top = 0;
                //垂直布局底部留边，最后一行不留
                if (need_top_margin && itemPosition == 0)
                    top = mDividerHeight;
                outRect.set(0, top, 0, (itemPosition != childCount) ? mDividerHeight : 0);
    ...
    private void drawHorizontal(Canvas canvas, RecyclerView parent) {
        ...
        for (int i = 0; i < childSize - no_need_divider; i++) {
            final View child = parent.getChildAt(i);
            RecyclerView.LayoutParams layoutParams =
                    (RecyclerView.LayoutParams) child.getLayoutParams();
            //item底部的Y轴坐标+margin值
            final int y = layoutParams.topMargin + child.getBottom() + layoutParams.bottomMargin;
