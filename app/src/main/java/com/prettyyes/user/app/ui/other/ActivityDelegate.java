...
public class ActivityDelegate {
    ...
    public ActivityDelegate(Activity activity, @Nullable String mainComponentName) {
        mActivity = activity;
     ...
     * {@link Activity#getApplication()} is an appacountinstance of {@link ReactApplication} and calls
