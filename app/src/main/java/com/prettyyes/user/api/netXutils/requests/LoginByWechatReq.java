...
public class LoginByWechatReq extends BaseRequest<UserInfo> {

    @Override
    public String setExtraUrl() {
        return "/app/wechat/authUMeng";
    }
    ...
    public LoginByWechatReq setOpenId(String openid) {
        this.openid = openid;
        return this;
    }

    public LoginByWechatReq setAccess_token(String access_token) {
