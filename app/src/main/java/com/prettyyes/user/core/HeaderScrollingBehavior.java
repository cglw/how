 ...
 */
public class HeaderScrollingBehavior extends CoordinatorLayout.Behavior<SwipeRecycleView> {
    ...
    //代表依赖哪个view
    @Override
    public boolean layoutDependsOn(CoordinatorLayout parent, SwipeRecycleView child, View dependency) {
    ...
    //绘制子
    @Override
    public boolean onLayoutChild(CoordinatorLayout parent, SwipeRecycleView child, int layoutDirection) {
    ...
    //依赖的view发送改变的时候
    @Override
    public boolean onDependentViewChanged(CoordinatorLayout parent, SwipeRecycleView child, View dependency) {
    ...
    @Override
    public boolean onStartNestedScroll(CoordinatorLayout coordinatorLayout, SwipeRecycleView child, View directTargetChild, View target, int nestedScrollAxes) {
        return (nestedScrollAxes & ViewCompat.SCROLL_AXIS_VERTICAL) != 0;
    }

    @Override
    public void onNestedScrollAccepted(CoordinatorLayout coordinatorLayout, SwipeRecycleView child, View directTargetChild, View target, int nestedScrollAxes) {
    ...
    @Override
    public void onNestedPreScroll(CoordinatorLayout coordinatorLayout, SwipeRecycleView child, View target, int dx, int dy, int[] consumed) {
        if (dy < 0) {
            return;
        }
    ...
    @Override
    public void onNestedScroll(CoordinatorLayout coordinatorLayout, SwipeRecycleView child, View target, int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed) {
        LogUtil.i(TAG,"onNestedScroll"+dyUnconsumed);
    ...
    @Override
    public boolean onNestedPreFling(CoordinatorLayout coordinatorLayout, SwipeRecycleView child, View target, float velocityX, float velocityY) {
        LogUtil.i(TAG,"onNestedPreFling"+velocityY);

        return onUserStopDragging(velocityY);
    }

    @Override
    public void onStopNestedScroll(CoordinatorLayout coordinatorLayout, SwipeRecycleView child, View target) {
        if (!isScrolling) {
