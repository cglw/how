 ...
 * @日 期:
 */
public class FragmentTabCopyUtils implements RadioGroup.OnCheckedChangeListener {
     ...
     * @param rgs
     */
    public FragmentTabCopyUtils(int pageIndex, FragmentManager fragmentManager, List<Fragment> fragments, int fragmentContentId, RadioGroup rgs, OnRgsExtraCheckedChangedListener listener, final Context context) {
    ...
    public void onCheckedChanged(RadioGroup radioGroup, int checkedId) {
        for (int i = 0; i < rgs.getChildCount(); i++) {
            ((RadioButton) rgs.getChildAt(i)).setTextColor(Color.rgb(180, 180, 180));
