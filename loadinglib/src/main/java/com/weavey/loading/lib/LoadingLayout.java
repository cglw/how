...
public class LoadingLayout extends FrameLayout {
    ...
    public boolean isFirstVisible; //是否一开始显示contentview，默认不显示
...
//        pageBackground = Utils.getColor(mContext, R.color.bg_app_defaule);
        pageBackground =  ContextCompat.getColor(context, R.color.bg_app_defaule);
//        a.getColor(R.styleable.LoadingLayout_pageBackground, Utils.getColor(mContext, R.color.bg_app_defaule));
        a.recycle();
    ...
    private void build() {
        ...
        loadingText = Utils.findViewById(loadingPage, R.id.tv_loading);
