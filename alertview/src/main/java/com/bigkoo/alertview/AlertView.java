...
public class AlertView implements Serializable {
    ...
    public AlertView setAlertView(String title, String msg, String cancel, String[] destructive, String[] others, Context context, Style style, OnItemClickListener onItemClickListener) {
        this.contextWeak = new WeakReference<>(context);
        if (style != null) this.style = style;
        this.onItemClickListener = onItemClickListener;
...
//            ViewGroup viewstub = (ViewGroup) layoutInflater.inflate(R.layout.layout_alertview_actionsheet, contentContainer);
